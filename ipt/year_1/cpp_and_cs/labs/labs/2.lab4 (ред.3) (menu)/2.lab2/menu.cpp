	...
	else
	{
		...
		else
		{
			if (A1.infoname()!="UNKNOWN")
			{
				...
				//cout<<A1.infoexperience()<<"  "<<B2.infoexperience();
				//cout<<endl;
			...
			else if (A1.infoname()=="UNKNOWN")
			{
				...
				//cout<<B1.infoexperience()<<"  "<<A2.infoexperience();
				//cout<<endl;
...
bool Base::showallBase()
	{
		...
		else
		{
			...
			{
				cout<<i+1<<". ";
				if (baseofworkers[i].infoname()!="2")
				{
					cout<<"Name: "<<baseofworkers[i].infoname();
					cout<<endl<<"   Age: "<<baseofworkers[i].infoage();
					cout<<endl<<"   Post: "<<baseofworkers[i].infopost();
					cout<<endl<<"   Experience: "<<baseofworkers[i].infoexperience();
				}
				else
				{
					cout<<"Name: "<<baseofpworkers[i].infoname();
					cout<<endl<<"   Age: "<<baseofpworkers[i].infoage();
					cout<<endl<<"   Post: "<<baseofpworkers[i].infopost();
					cout<<endl<<"   Experience: "<<baseofpworkers[i].infoexperience();
					cout<<endl<<"   "<<baseofpworkers[i].infoname()<<" has bonuses:"<<endl;
					for (int j=0; j<baseofpworkers[i].infoquantity(); j++)
					{
						if (baseofpworkers[i].infobonus()[j]=="")
							cout<<"   "<<j+1<<". UNKNOWN"<<endl;
						else cout<<"   "<<j+1<<". "<<baseofpworkers[i].infobonus()[j]<<endl;
					}
				}
				//cout<<"///////////////////////////////////////////"<<endl;
				cout<<endl;
